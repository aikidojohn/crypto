...
public class FF1Test {
    ...
    public void testEncryptWithLargeData() throws Exception {
        ...
        System.out.println(encrypted);
        Assert.assertEquals("jt7kfwms77q8j0qm9osehwdao5w45zeuduykbijo9ofwociihsmqao6p4asr27caddrqpn7huxi7", encrypted);
    }
    ...
    public void testDecryptWithLargeData() throws Exception {
        ...
        System.out.println(encrypted);
        Assert.assertEquals("0123456789abcdefghi0123456789abcdefghi0123456789abcdefghi0123456789abcdefghi", encrypted);
    }
